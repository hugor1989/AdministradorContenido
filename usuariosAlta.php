      ...
      <div class="container-fluid">
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Módulo para agregar usuarios / empresas a plataforma</h3>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control" id="nombrenegocio" name="nombrenegocio" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" placeholder="Nombre comercial del Negocio"><span class="input-group-append">
          ...
          <div class="card-body">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <?php 
                  $query="select * from th_cat_usuariosroles where rol_estatus=1";
                  $res = mysqli_query($con,$query);
                  ?>
                  <select class="form-control select2 select2" id="rol" name="rol" required>
                                <?php
                                while ($Usuario = mysqli_fetch_array($res)) {
                                    echo '<option value="' . $Usuario['rol_id'] . '">'.strtoupper($Usuario['rol_descripcion']). '</option>';
                                }
                                ?>
                  </select>
                </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <?php 
                  $query="select * from th_cat_girosempresas where giremp_estatus=1";
                  $res = mysqli_query($con,$query);
                  ?>
