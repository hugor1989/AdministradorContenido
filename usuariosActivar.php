  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>LISTADO DE USUARIOS SIN REGISTRO TERMINADO</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Thirsty</a></li>
              <li class="breadcrumb-item active">Usuarios sin activar</li>
            </ol>
          </div>
        </div>
      </div>
              ...
              <tbody>
                <?php
                  ...
                  $query = "SELECT * from th_usuarios u
                            where u.usr_estatus=1 and u.usr_idRol=1";
                  ...
                  <tr>
                      ...
                      <td><a class="btn btn-success btn-sm" href="usuarioTerminarRegistro?idUsuario=<?php echo $registro['usr_idUsuario']; ?>"><i class="fas fa-info"></i> Terminar registro</a>
                          <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#verDatosAcuse" id="btnActivate" onclick="agregaform('<?php echo $datos ?>')"> <i class="fas fa-edit"> Activar
                              </i>
                      </button>
                      </td>
                  </tr>
