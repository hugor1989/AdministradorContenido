  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>ALTA DE USUARIOS / EMPRESA</h1>
          </div>
          <div class="col-sm-6">
  ...
  <section class="content">
      <div class="container-fluid">
          ...
          <div class="card-header">
            <h3 class="card-title">Datos generales de usuario para el registro</h3>
          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="plazopago" name="plazopago" value="7" readonly>
                </div>
              </div>
            </div>
            ...
            <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="slider-blue">
                      <input type="text" id="monto" name="monto" value="" class="slider form-control" data-slider-max="20000"
                           data-slider-step="500" data-slider-value="[0,20000]" data-slider-orientation="horizontal"
            ...
            <hr color="blue">
            <code>Datos de la referencia comercial 1</code>
              <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <label>Nombre Ref1</label>
                  <div class="input-group">
                      <div class="custom-file">
                        <input type="text" class="form-control" id="nameref1" name="nameref1" placeholder="Nombre de la referencia 1">
                      </div>
                    </div> 
                </div>
              </div>
              <div class="col-md-2">
                <div class="form-group">
                  <label>Teléfono Ref1</label>
                  <input type="text" class="form-control" id="telref1" name="telref1" placeholder="Teléfono de referencia 1">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label>DirecciónRef1</label>
                  <input type="text" class="form-control" id="dirref1" name="dirref1" placeholder="Dirección de referencia 1">
                </div>
              </div>
            </div>

            <code>Datos de la referencia comercial 2</code>
              <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <label>Nombre Ref1</label>
                  <div class="input-group">
                      <div class="custom-file">
                        <input type="text" class="form-control" id="nameref2" name="nameref2" placeholder="Nombre de la referencia 2">
                      </div>
                    </div> 
                </div>
              </div>
              <div class="col-md-2">
                <div class="form-group">
                  <label>Teléfono Ref1</label>
                  <input type="text" class="form-control" id="telref2" name="telref2" placeholder="Teléfono de referencia 2">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label>DirecciónRef1</label>
                  <input type="text" class="form-control" id="dirref2" name="dirref2" placeholder="Dirección de referencia 2">
                </div>
              </div>
            </div>
                        <hr color="blue">
            ...
            <button type="submit" class="btn btn-success">Guardar datos de registro</button>
            </div>
            </div>
          </div>
        </div>
